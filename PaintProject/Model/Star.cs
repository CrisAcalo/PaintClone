...
namespace PaintProject.Model
{
    public class Star
    {
        ...
        public Star(PictureBoxCanvas canvas)
        {
            this.canvas = canvas;
        }
        ...
        public void MouseUp(MouseEventArgs e)
        {
            ...
            {
                isDrawing = false;
                DrawStar(startPoint, e.Location);
            }
        }

        private void DrawStar(Point start, Point end)
        {
            ...
            double angle = 2 * Math.PI / 10; // 36 grados en radianes
